    ...
    function addActiveClass(element) {
        ...
        try {
            if (href && href.startsWith('http')) {
                ...
                return; // Skip if href is invalid or just #
            }
        } catch (e) {
            // If href is just '#' or relative, skip
            if (!href || href === '#' || href === '') {
                return;
            }
        }
        ...
        // Check if current pathname matches the link path
        if (href && pathname && href !== '' && pathname !== '') {
            if (pathname === href) {
                ...
                // Path is a parent of current (but not root)
                element.parents('.nav-item').last().addClass('active');
                element.addClass('active');
            }
